...
def fetch_image_urls(query: str, max_links_to_fetch: int, wd: webdriver, sleep_between_interactions: int = 2):
    search_url = "https://www.google.com/search?sca_esv=557132508&rlz=1C1VDKB_enIN970IN970&q=coding+memes&tbm=isch&source=lnms&sa=X&ved=2ahUKEwiUu6_Ght-AAxVVGogKHa97B98Q0pQJegQICxAB&biw=1366&bih=619&dpr=1"
